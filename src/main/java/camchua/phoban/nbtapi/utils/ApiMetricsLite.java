                  ...
                  if (plugin instanceof JsonObject) {
                     ...
                     try {
                        ...
                        if (logFailedRequests) {
                           MinecraftVersion.getLogger().log(Level.WARNING, "[NBTAPI][BSTATS] Encountered exception while posting request!", var12);
                        }
                     }
                  }
         ...
         public void run() {
            try {
               ...
               if (ApiMetricsLite.logFailedRequests) {
                  MinecraftVersion.getLogger().log(Level.WARNING, "[NBTAPI][BSTATS] Could not submit plugin stats of " + ApiMetricsLite.this.plugin.getName(), var2);
               }
            }
